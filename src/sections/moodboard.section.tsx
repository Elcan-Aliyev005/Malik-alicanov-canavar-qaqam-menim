...
function MoodboardSection() {
    return (
        <section className={'bg-[#0D6E0D] mb-[25px] lg:pt-3 lg:pl-[56px] lg:bg-[#108910] block lg:flex justify-between items-center rounded-[24px] min-h-[337px] lg:h-[600px] xl:h-[683px]'}>
